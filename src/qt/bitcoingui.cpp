    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ensocoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ensocoin address"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Ensocoin"), this);
    aboutAction->setStatusTip(tr("Show information about Ensocoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ensocoin"));
    ...
    unlimitedAction->setStatusTip(tr("Modify Ensocoin Options"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ensocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ensocoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Ensocoin help message to get a list with possible Ensocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ensocoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ensocoin network", "", count));
}
...
{
    QString strTitle = tr("Ensocoin"); // default title
