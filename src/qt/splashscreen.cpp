    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceUnlimited = 54;
    ...
    QString titleText       = tr("REPLACE_1_PROJNAME");
    ...
    QString copyrightUnlimited   = QChar(0xA9)+QString(" 2015-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The REPLACE_1_PROJNAME developers"));
