...
By default, REPLACE_1_PROJNAME_MD allows up to 125 connections to different peers,
...
REPLACE_1_PROJNAME_MD adds traffic shaping which is controlled by the following
