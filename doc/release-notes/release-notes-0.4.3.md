...
Use the correct base transaction fee of 0.0005 REPLACE_1_COIN for accepting transactions into mined blocks (since 0.4.0, it was incorrectly accepting 0.0001 REPLACE_1_COIN which was only meant to be relayed).
