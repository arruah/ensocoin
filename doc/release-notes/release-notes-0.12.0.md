...
`ensocoin.conf`, where `N` is the number of MiB to allot for
raw block & undo data.
...
Then, to tunnel a SSL connection on 28332 to a RPC server bound on localhost on port 17992 do:

    stunnel -d 28332 -r 127.0.0.1:17992 -p stunnel.pem -P ''
